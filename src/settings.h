...
//Weather Settings
#define CITY_ID "2965140" //Cork City https://openweathermap.org/current#cityid
...
#define OPENWEATHERMAP_APIKEY "ad44c7750acf6505817451fab702aa06" //use your own API key :)
